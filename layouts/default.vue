<template>
  <div id="MainLayout" class="w-full fixed z-50">
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div
        class="flex lg:justify-start justify-beetween gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto"
      >
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            <div
              class="flex flex-center border-2 border-[#ff4646] rounded-md w-full"
            >
              <input
                class="w-full placeholder-gray-400 text-semibold pl-3 focus:outline-none"
            ...
            <div class="absolute bg-white max-w-[700px] h-auto w-full">
              <div v-if="false" class="p-1">
                <NuxtLink
                  to="`/item/${1}`"
                  class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-00"
                >
