    ...
    <div class="mx-auto bg-white rounded-lg p-3">
      ...
      <form @submit.prevent="submit()">
        ...
        <TextInput
          ...
          inputType="text"
          v-bind:error="error && error.type == 'address' ? error.message : ''"
        />
        ...
        <TextInput
          ...
          inputType="text"
          v-bind:error="error && error.type == 'zipCode' ? error.message : ''"
        />
        ...
        <TextInput
          ...
          v-model:input="city"
          inputType="text"
          v-bind:error="error && error.type == 'city' ? error.message : ''"
        />
        ...
        <TextInput
          ...
          inputType="text"
          v-bind:error="error && error.type == 'country' ? error.message : ''"
        />
